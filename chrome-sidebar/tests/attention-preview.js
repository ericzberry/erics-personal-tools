...
let failed=false;
let records=[{...normalizeSubscription({name:'Synthetic family streaming subscription with a very long name',currency:'USD',amount:19.99,cycle:'monthly',state:'Active',renewal:'2026-09-20',account:'Everyday card',charges:[{on:'2026-07-20',amount:14.99,description:'SYNTHETIC STREAM',source:'July statement'},{on:'2026-08-20',amount:19.99,description:'SYNTHETIC STREAM',source:'August statement'}]}),id:'one',revision:'first'},{...normalizeSubscription({name:'Canceled gym membership',currency:'USD',state:'Canceled',canceledOn:'2026-08-01',charges:[{on:'2026-09-01',amount:40,description:'SYNTHETIC GYM'}]}),id:'two',revision:'first'}];
