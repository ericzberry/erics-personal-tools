...
import {RecommendationCard,Field,DataTable,Button} from '../src/components/ui.js';
...
test('all screens mount through components with unique, accessible controller hooks',()=>{
  ...
  assert.ok(doc.getElementById('rankings-file').hidden);assert.equal(doc.getElementById('rankings-drop').tagName,'BUTTON');
