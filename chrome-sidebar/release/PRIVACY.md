...
In ESPN football draft rooms, the extension reads visible selections, team names and identifiers, league and season identifiers, draft order and progress. Captured sessions and custom ranking boards are stored in Chrome extension storage on your device. The extension retains up to ten practice sessions and the configured league session.
