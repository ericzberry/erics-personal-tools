...
export function CapabilitiesView(){
  return Stack([CapabilityPicker(),Stack([],{id:'capability-connection',className:'travel-wallet connection-only'}),Note('Choose a tool to view your saved data.',{id:'capability-intro'}),...CAPABILITIES.map(c=>Section([],{id:`capability-${c.id}`,hidden:true}))]);
}
