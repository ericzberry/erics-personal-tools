...
export function mountApp(root) {root.replaceChildren(AppHeader({}),UI.PageOfferBar(),DraftView(),GmailView(),HomeView(),RewardsView(),Section([],{id:'travel-tool',hidden:true}),Section([],{id:'finance-tool',className:'tool-page',hidden:true}),Section([],{id:'taxes-tool',className:'tool-page',hidden:true}),Section([],{id:'properties-tool',className:'tool-page',hidden:true}),SettingsView());}
