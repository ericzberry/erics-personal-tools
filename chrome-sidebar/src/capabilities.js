...
// Every entry needs an `icon`: a 24x24 stroked SVG path drawn with currentColor.
// The mobile launcher renders these, so a capability without one cannot be reached.
