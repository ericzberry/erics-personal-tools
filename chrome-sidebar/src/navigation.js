...
function render(){
  ...
  for(const key of ['football','finance','gmail','home','rewards','taxes','travel','attention','subscriptions','gifts','reminders','cards','personal'])$(`${key}-tool`).hidden=settingsOpen||key!==active;
