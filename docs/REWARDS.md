...
on is reported rather than given one — Best card reads this wallet for the cards
you hold, so one of those appears there awaiting its rates rather than a card to
add again.
