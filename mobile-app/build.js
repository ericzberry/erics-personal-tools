...
const shared=['subscription-data.js','subscriptions-offline.js','subscriptions.js','ai-connection.js','components/subscriptions.js','attention-data.js','attention.js','components/attention.js','components/tokens.css','components/status.css','rewards-tool.js','rewards-data.js','balance-data.js','rewards-offline.js','program-data.js','program-offline.js','secret-vault.js','idle-session.js','auto-unlock.js','components/rewards.js','components/select.js','components/select.css','components/upload.css','cards.js','card-data.js','cards-offline.js','components/cards.js','components/cards.css','restaurant-search.js','components/restaurant-views.js','components/workspace.css','travel.js','travel-data.js','travel-offline.js','offline-resource.js','offline-storage.js','capabilities.js','data-library.js','cloud-storage.js','components/ui.js','components/travel.js','components/travel.css','finance.js','finance-data.js','finance-offline.js','components/finance.js','components/finance.css','pdf-text.js','pdf-crypt.js','pdf-unlock.js','statement-text.js','finance-page-read.js','components/file-drop.js','personal.js','personal-data.js','personal-offline.js','components/personal.js','reminders.js','reminder-data.js','reminders-offline.js','components/reminders.js','components/reminders.css','gifts.js','gift-data.js','gifts-offline.js','public-url.js','components/gifts.js','components/gifts.css','sizes.js','size-data.js','sizes-offline.js','components/sizes.js','components/sizes.css','capture.js','capture-data.js','capture-stores.js','components/capture.js','components/capture.css','taxes.js','tax-data.js','components/taxes.js','components/taxes.css','vault-gate.js','components/vault.js','components/vault.css','components/capabilities.js','components/capabilities.css'];
