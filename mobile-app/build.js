...
const shared=['components/tokens.css','rewards-tool.js','rewards-data.js','rewards-offline.js','secret-vault.js','idle-session.js','auto-unlock.js','components/rewards.js','components/select.js','components/select.css','components/upload.css','cards.js','card-data.js','cards-offline.js','components/cards.js','components/cards.css','restaurant-search.js','components/restaurant-views.js','components/workspace.css','travel.js','travel-data.js','travel-offline.js','offline-resource.js','offline-storage.js','capabilities.js','data-library.js','cloud-storage.js','components/ui.js','components/travel.js','components/travel.css','finance.js','finance-data.js','finance-offline.js','components/finance.js','components/finance.css','pdf-text.js','statement-text.js','finance-page-read.js','components/file-drop.js','personal.js','personal-data.js','personal-offline.js','components/personal.js','taxes.js','tax-data.js','components/taxes.js','components/taxes.css','vault-gate.js','components/vault.js','components/vault.css','components/capabilities.js','components/capabilities.css'];
